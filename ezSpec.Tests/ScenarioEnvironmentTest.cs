...
public class ScenarioEnvironmentTest {
    ...
    public static void BeforeAll(TestContext context) {
        ...
        Row inputRow = Row.New(inputHeader, new List<string>() {
            "10001",
            "Joe",
            "60"
        });
        ...
        List<Row> anonymousRows = new List<Row>() {
            Row.New(anonymousHeader, new List<string>() {
                "20001",
                "Anna",
                "70"
            })
    ...
    public void set_execution_count() {
        ...
        setExecutionCountMethod?.Invoke(env, new object[] {
            1
        });
    ...
    public void set_input() {
        ...
        setInputTableMethod?.Invoke(env, new object[] {
            inputExample
        });
    ...
    public void set_arguments() {
        ...
        setArgumentsMethod?.Invoke(env, new object[] {
            arguments1
        });
