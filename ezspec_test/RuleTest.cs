...
public class RuleTest {
    ...
    public void rule_with_background_and_scenario() {
        ...
        rule.NewScenario("buy three kinds of fruits")
            ...
            .Then("I should pay ${195}", env => { Assert.AreEqual(env.GetInt("totalPrice"), env.GetIntArg(0)); })
            .Execute();
    }
    ...
    public void rule_with_background_and_two_scenarios() {
        ...
        rule.NewScenario("buy apple and banana")
            ...
            .Then("I should pay ${160}", env => { Assert.AreEqual(env.GetInt("totalPrice"), env.GetIntArg(0)); })
            .Execute();
        ...
        rule.NewScenario("buy banana and orange")
            ...
            .Then("I should pay ${95}", env => { Assert.AreEqual(env.GetInt("totalPrice"), env.GetIntArg(0)); })
            .Execute();
    }
